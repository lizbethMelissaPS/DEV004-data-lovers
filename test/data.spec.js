import { filterDataType } from '../src/data.js';
...
/* describe('filterDataType', () => {
  ...
  it('returns `filterDataType`', () => {
    expect(filterDataType(dataPokemon,'grass')).toStrictEqual([ {
      "num": "001",
      "name": "bulbasaur",
      "generation": {
        "num": "generation i",
...
describe("filter TYPE POKEMON", () => {
  ...
  it("return todos lo pokemosnes de tipo grass", () => {
    const actual2 = [
      {
        "num": "001",
        "name": "bulbasaur",
    ...
    expect(filterDataType(actual2, "grass")).toEqual([
      {
        "num": "001",
        "name": "bulbasaur",
        "generation": {
